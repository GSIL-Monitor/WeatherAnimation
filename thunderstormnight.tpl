<canvas id="mh-scene-thunderstormnight"></canvas>
<canvas id="mh-scene-thunderstormnight-comp1"></canvas>
<script>
	So.onebox.objective('So.onebox.weather.configs.thunderstormday',
		{
			sceneId:'mh-scene-thunderstormnight',
			sceneEle:{
				components:[
					/*后层云朵*/
					{
						src:'http://p4.qhimg.com/t01c33347f3c85bf99e.png',
						shape:{
							width:265,
							height:100
						},
					...
					/*中层云朵*/
					{
						src:'http://p8.qhimg.com/t012690b6bd2053dc02.png',
						shape:{
							width:250,
							height:86
						},
					...
					/*前层云朵*/
					{
						src:'http://p4.qhimg.com/t01325c00fdeb8b5c7c.png',
						shape:{
							width:221,
							height:67
						},
					...
					/*闪电*/
					{
						...
						canvas:{
							id:'mh-scene-thunderstormnight-comp1',
							width:540,
							height:260,
							left:0,
							top:0
