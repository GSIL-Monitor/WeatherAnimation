{%*<canvas id="mh-scene-windnight"></canvas>
<canvas id="mh-scene-windnight-comp1"></canvas>
<canvas id="mh-scene-windnight-comp2"></canvas>
<canvas id="mh-scene-windnight-comp4"></canvas>
<canvas id="mh-scene-windnight-comp5"></canvas>
<script>
	So.onebox.objective('So.onebox.weather.configs.windnight',
		{
			sceneId:'mh-scene-windnight',
			sceneEle:{
				components:[
					/*moon*/
					{
						src:'http://p1.qhimg.com/t0128ab8b936e6b2990.png',
						shape:{
							width:71,
							height:71
						},
					...
					/*沙尘最大的*/
					{
						src:'http://p2.qhimg.com/t015f8ee98500539bba.png',
						shape:{
							width:450,
							height:160
						},
					...
					/*树1*/
					{
						...
						init:function(){
							...
							for(var i=0; i<treeNum; i++){
								var tree = new _this.Tree(posX + i * spaceX, posY + i * spaceY, treeSize, deviation, 2, 2, 5);
					...
					/*树2*/
					{
						...
						init:function(){
							...
							for(var i=0; i<treeNum; i++){
								var tree = new _this.Tree(posX + i * spaceX, posY + i * spaceY, treeSize, deviation, 3, 2, 5);
								_this.animation.eles.push(tree);
							}
						},
						animate:function(){
...
<style>
	#mohe-weather .mh-windnight-moon {
	    background: url(http://p1.qhimg.com/t0128ab8b936e6b2990.png) no-repeat;
	    width: 71px;
	    height: 71px;
	    position: absolute;
	...
	#mohe-weather .mh-windnight-cloudmoon {
		background: url(http://p2.qhimg.com/t015f8ee98500539bba.png) no-repeat;
		width: 343px;
		height: 58px;
		position: absolute;
		background-size: contain;
	...
	#mohe-weather .mh-windnight-cloudmax {
		background: url(http://p2.qhimg.com/t015f8ee98500539bba.png) no-repeat;
		width: 450px;
		height: 160px;
		position: absolute;
	...
	#mohe-weather .mh-windnight-cloudfront {
		background: url(http://p2.qhimg.com/t015f8ee98500539bba.png) no-repeat;
		width: 220px;
		height: 71px;
		position: absolute;
...
<div class="mh-dom-wraper">
	<div class="mh-windnight-moon"></div>
	<div class="mh-windnight-cloudmoon"></div>
	<div class="mh-windnight-cloudmax"></div>
	<div class="mh-windnight-cloudfront"></div>
</div>
<canvas id="mh-scene-windnight"></canvas>
<canvas id="mh-scene-windnight-comp2"></canvas>
<canvas id="mh-scene-windnight-comp4"></canvas>
