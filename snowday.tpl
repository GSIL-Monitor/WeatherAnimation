<canvas id="mh-scene-snowday"></canvas>
<canvas id="mh-scene-snowday-comp1"></canvas>
<script>
	So.onebox.objective('So.onebox.weather.configs.snowday',
		{
			sceneId:'mh-scene-snowday',
			sceneEle:{
				components:[
					/*sun*/
					{
						src:'http://p2.qhimg.com/t01f550ab1c6fc00b80.png',
						shape:{
							width:110,
							height:110
						},
